...
if (answer.operator === "Addition") {
    console.log("your value is :", answer.firstNumber, "+", answer.secondNumber, "=", answer.firstNumber + answer.secondNumber);
}
else if (answer.operator === "Substraction") {
    console.log("your value is :", answer.firstNumber, "-", answer.secondNumber, "=", answer.firstNumber - answer.secondNumber);
}
else if (answer.operator === "Multiplication") {
    console.log("your value is :", answer.firstNumber, "x", answer.secondNumber, "=", answer.firstNumber * answer.secondNumber);
}
